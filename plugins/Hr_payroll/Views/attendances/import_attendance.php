...
$file_header[] = app_lang('integration_actual_workday');
$file_header[] = app_lang('integration_paid_leave');
$file_header[] = app_lang('integration_unpaid_leave');
$file_header[] = app_lang('standard_working_time_of_month');
		...
		<div class="col-sm-12 col-lg-12">
			<div class="card pr15 pl15">
				<div class="page-title clearfix">
					<h4 class="no-margin font-bold"><i class="fa fa-clone menu-icon menu-icon" aria-hidden="true"></i> <?php echo app_lang('hrp_import_attendance'); ?></h4>
					<div class="title-button-group">
						<div class="row">
							<div class="col-md-6 mt-3">
								<?php echo render_input1('month_attendance','',date('Y-m'), 'month'); ?>   
							</div>
				...
				<?php if(!isset($simulate)) { ?>
					<ul>
						<li class="text-danger">1. <?php echo app_lang('file_xlsx_attendance1'); ?></li>
						<li class="text-danger">2. <?php echo app_lang('file_xlsx_attendance2'); ?></li>
					</ul>
				...
				<div class="row">
					<div class="col-md-4">
						...
						<div class="form-group">
							<a href="<?php echo get_uri('hr_payroll/manage_attendance'); ?>" class="btn btn-default pull-left display-block mr-5 button-margin-r-b" title="<?php echo app_lang('close') ?> "><span data-feather="x" class="icon-16"></span> <?php echo app_lang('hrp_back'); ?>
						</a>
						<?php if(hrp_has_permission('hr_payroll_can_create_hrp_attendance') || hrp_has_permission('hr_payroll_can_edit_hrp_attendance')){ ?>
...
<?php require('plugins/Hr_payroll/assets/js/attendances/import_attendance_js.php'); ?>
