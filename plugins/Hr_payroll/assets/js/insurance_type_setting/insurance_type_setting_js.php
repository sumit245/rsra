<script>      
  ...
  function edit_insurance_type(invoker,id){
    ...
    var new_html1 = "<?php echo app_lang('social_insurance'); ?>" + '(' + total1 + '%' + ')' ;
    ...
    var new_html2 = "<?php echo app_lang('labor_accident_insurance'); ?>" + '(' + total2 + '%' + ')' ;
    ...
    var new_html3 = "<?php echo app_lang('health_insurance'); ?>" + '(' + total3 + '%' + ')' ;
    ...
    var new_html4 = "<?php echo app_lang('unemployment_insurance'); ?>" + '(' + total4 + '%' + ')' ;
  ...
  function social_staff_change(invoker){
    ...
    var new_html = "<?php echo app_lang('social_insurance'); ?>" + '(' + total + '%' + ')' ;
  ...
  function labor_accident_staff_change(invoker){
    ...
    var new_html = "<?php echo app_lang('health_insurance'); ?>" + '(' + total + '%' + ')' ;
  ...
  function health_staff_change(invoker){
    ...
    var new_html = "<?php echo app_lang('labor_accident_insurance'); ?>" + '(' + total + '%' + ')' ;
  ...
  function unemployment_staff_change(invoker){
    ...
    var new_html = "<?php echo app_lang('unemployment_insurance'); ?>" + '(' + total + '%' + ')' ;
