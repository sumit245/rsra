<script>
	...
	$(function(){
		...
		initDataTable(staff_payslip, "<?php echo get_uri("hr_payroll/table_staff_payslip") ?>", [], [], ContractsServerParams,[2, 'desc']);
    ...
    function member_view_payslip(payslip_detail_id) {
      ...
      $("#contract_modal_wrapper").load("<?php echo get_uri("hr_payroll/view_staff_payslip_modal") ?>", {
           slug: 'view',
