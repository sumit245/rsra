...
global $permissions; // If it was declared globally
if (! isset($permissions)) {
 $permissions = []; // Prevent undefined variable error
}
...
app_hooks()->add_filter('app_filter_client_left_menu', function ($sidebar_menu) {
 ...
 $purchase_submenu["vendor_profile"] = [
  "name"  => "profile",
 ...
 $purchase_submenu["purchase_request"] = [
  "name"  => "purchase_request",
  "url"   => "purchase/purchase_request",
  "class" => "users",
 ];

 $purchase_submenu["quotations"] = [
  "name"  => "quotations",
  "url"   => "purchase/quotations",
  "class" => "users",
 ];

 $purchase_submenu["purchase_orders"] = [
  "name"  => "purchase_orders",
  "url"   => "purchase/purchase_orders",
  "class" => "users",
 ];

 $purchase_submenu["invoices"] = [
  "name"  => "invoices",
...
app_hooks()->add_filter('app_filter_staff_left_menu', function ($sidebar_menu) {
 ...
 if ($ci->login_user->is_admin || get_array_value($permissions, "inventory")) {
  ...
  $purchase_submenu["vendors"] = [
   "name"  => "vendors",
   "url"   => "purchase/vendors",
   "class" => "users",
  ];

  $purchase_submenu["vendor_items"] = [
   "name"  => "vendor_items",
