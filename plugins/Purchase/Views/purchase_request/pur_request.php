    ...
    <div class="page-title clearfix">
      <h4 class="no-margin font-bold">
        <?php if (isset($pur_request)) {
          echo html_entity_decode($pur_request->pur_rq_code);
        } else {
          echo html_entity_decode($title) . ' ' . _l('purchase_request');
        } ?>
      </h4>
    </div>
          ...
          <div class="col-md-3 form-group">
            ...
            <select name="department" id="department" class="select2 validate-hidden" onchange="department_change(this); return false;" data-live-search="true" data-width="100%" data-none-selected-text="<?php echo _l('ticket_settings_none_assigned'); ?>">
              ...
              <?php foreach ($departments as $s) { ?>
                <option value="<?php echo html_entity_decode($s['id']); ?>" <?php if (isset($pur_request) && $s['id'] == $pur_request->department) {
                                                                              echo 'selected';
          ...
          <div class="col-md-3 form-group">
            ...
            <select name="sale_estimate" id="sale_estimate" onchange="coppy_sale_estimate(); return false;" class="select2 validate-hidden" data-live-search="true" data-width="100%" data-none-selected-text="<?php echo _l('ticket_settings_none_assigned'); ?>">
              ...
              <?php foreach ($salse_estimates as $s) { ?>
                <option value="<?php echo html_entity_decode($s['id']); ?>" <?php if (isset($pur_request) && $s['id'] == $pur_request->sale_estimate) {
                                                                              echo 'selected';
                                                                            } ?>><?php echo get_estimate_id($s['id']); ?></option>
              <?php } ?>
            </select>
          ...
          <div class="col-md-3 form-group ">
            ...
            <select name="sale_invoice" onchange="coppy_sale_invoice(); return false;" id="sale_invoice" class="select2 validate-hidden" data-live-search="true" data-width="100%" data-none-selected-text="<?php echo _l('ticket_settings_none_assigned'); ?>">
              ...
              <?php foreach ($invoices as $inv) { ?>
                <option value="<?php echo html_entity_decode($inv['id']); ?>" <?php if (isset($pur_request) && $inv['id'] == $pur_request->sale_invoice) {
                                                                                echo 'selected';
          ...
          <div class="col-md-3 form-group">
            ...
            <select name="requester" id="requester" class="select2 validate-hidden" data-live-search="true" data-width="100%" data-none-selected-text="<?php echo _l('ticket_settings_none_assigned'); ?>">
              ...
              <?php foreach ($staffs as $s) { ?>
                <option value="<?php echo html_entity_decode($s['id']); ?>" <?php if (isset($pur_request) && $s['id'] == $pur_request->requester) {
                                                                              echo 'selected';
                                                                            } elseif ($s['id'] == get_staff_user_id()) {
                                                                              echo 'selected';
                                                                            } ?>><?php echo html_entity_decode($s['text']); ?></option>
              <?php } ?>
            </select>
          ...
          <div class="col-md-3 form-group">
            ...
            <select name="send_to_vendors[]" id="send_to_vendors" class="select2 validate-hidden" multiple="true" data-live-search="true" data-width="100%" data-none-selected-text="<?php echo _l('ticket_settings_none_assigned'); ?>">
              ...
              <?php foreach ($vendors as $s) { ?>
                <option value="<?php echo html_entity_decode($s['userid']); ?>" <?php if (isset($pur_request) && in_array($s['userid'], $vendors_arr)) {
                                                                                  echo 'selected';
                      ...
                      <td width="65%" id="total_td">
                        <div class="input-group" id="discount-total">
                          <input type="text" readonly="true" class="form-control text-right" name="subtotal" value="<?php if (isset($pur_request)) {
                                                                                                                      echo html_entity_decode($pur_request->subtotal);
                                                                                                                    } ?>">
                      ...
                      <td width="65%" id="total_td">
                        <div class="input-group" id="total">
                          <input type="text" readonly="true" class="form-control text-right" name="total_mn" value="<?php if (isset($pur_request)) {
                                                                                                                      echo html_entity_decode($pur_request->total);
                                                                                                                    } ?>">
                          <div class="input-group-addon">
                            <div class="dropdown">
