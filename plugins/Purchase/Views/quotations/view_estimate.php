  ...
  <div id="page-content" class="page-wrapper clearfix">
    <div class="card clearfix">
      ...
      <ul data-bs-toggle="ajax-tab" class="nav nav-tabs bg-white title" role="tablist">
        <li>
          <a href="#tab_estimate" class="<?php if ($tab == 'tab_estimate') {
                                            echo 'active';
                                          } ?>" data-bs-target="#tab_estimate" role="presentation">
      ...
      <div class="tab-content">
        ...
        <div role="tabpanel" class="tab-pane ptop10 <?php if ($tab == 'tab_estimate') {
                                                      echo 'active';
                                                    } ?>" id="tab_estimate">
                            ...
                            <?php } else { ?>
                              <div class="col-md-3 apr_div">
                                ...
                                <p class="bold text-center text-<?php if ($value['approve'] == 2) {
                                                                  ...
                                                                  echo 'danger';
                                                                } ?>"><?php echo format_to_date($value['date']); ?></p>
                              </div>
                          <?php }
                          } ?>
                        </div>
