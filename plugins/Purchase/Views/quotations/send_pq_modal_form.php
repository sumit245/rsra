<?php echo form_open(get_uri("purchase/send_pur_quotation"), array("id" => "send-pq-form", "class" => "general-form", "role" => "form")); ?>
<div id="send_pq-dropzone" class="post-dropzone">
    <div class="modal-body clearfix">
        <div class="container-fluid">
            <input type="hidden" name="id" value="<?php echo html_entity_decode($pq_info->id); ?>" />
            ...
            <div class="form-group">
                <div class="row">
                    <label for="pq_cc" class=" col-md-3">CC</label>
                    <div class="col-md-9">
                        <?php
            ...
            <div class="form-group">
                <div class="row">
                    <label for="pq_bcc" class=" col-md-3">BCC</label>
                    <div class="col-md-9">
                        <?php
                        echo form_input(array(
                            "id" => "pq_bcc",
            ...
            <div class="form-group ml15">
                <i data-feather="check-circle" class='icon-16 text-success' ></i> <?php echo app_lang('attached') . ' ' . anchor(get_uri("purchase/purestimate_pdf/" . $pq_info->id), format_pur_estimate_number($pq_info->id) . ".pdf", array("target" => "_blank")); ?> 
            </div>
...
<script type="text/javascript">
    $(document).ready(function () {
        ...
        $('#send-pq-form .select2').select2();
        $("#send-pq-form").appForm({
        ...
        $("#contact_id").select2().on("change", function () {
            ...
            if (contact_id) {
                ...
                appLoader.show();
                $.ajax({
                    url: "<?php echo get_uri('purchase/get_send_pq_template/' . $pq_info->id) ?>" + "/" + contact_id + "/json",
                    dataType: "json",
