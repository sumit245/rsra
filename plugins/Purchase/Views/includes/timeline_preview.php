...
if ($files && count($files)) {
    ...
    foreach ($files as $file) {
        ...
        $url = base_url('plugins/Purchase/Uploads/vendor_items/'.$file["rel_id"].'/'.$file["file_name"]);
        $thumbnail = base_url('plugins/Purchase/Uploads/vendor_items/'.$file["rel_id"].'/'.$file["file_name"]);
