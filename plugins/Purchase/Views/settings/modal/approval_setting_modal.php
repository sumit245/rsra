<?php echo form_open(get_uri("purchase/approval_setting/" . $id), ["id" => "approval_setting-form", "class" => "general-form", "role" => "form"]); ?>
		...
		<div class="container-fluid">
			<div class="row">
				<div class="col-md-12">
					...
					<label for="name"><span class="text-danger">* </span><?php echo app_lang('subject'); ?></label>
					...
					<?php echo render_select1('related', $related, ['id', 'name'], '', $related_value, [], [], '', '', false); ?>
