<?php purchase_load_css(["assets/css/purchase_style.css"]); ?>
  ...
  <div class="row">
    <div class="col-sm-3 col-lg-2">
      <ul class="list-group help-catagory">
        ...
        ?>
          <a role="presentation" class="list-group-item<?php if ($group == $hook_tab) {
                                                          echo 'active';
                                                        } ?>" href="<?php echo_uri('purchase/settings?group=' . $hook_tab); ?>" data-bs-target="#<?php echo html_entity_decode($hook_tab); ?>"><?php echo app_lang($hook_tab); ?></a>
        <?php
        }
        ?>
      </ul>
    ...
    <div class="col-sm-9 col-lg-10">
      <div class="card clearfix">
        <div class="tab-content ml15 mr15">
          <div role="tabpanel" class="tab-pane fade                                                    <?php if ($group == 'purchase_order_settings') {
                                                                                                          echo 'active show';
                                                                                                        } ?>" id="purchase_order_settings">
            <?php echo form_open_multipart('purchase/pur_order_setting', ['id' => 'pur_order_setting-form', 'class' => 'general-form']); ?>
          ...
          <div role="tabpanel" class="tab-pane fade                                                    <?php if ($group == 'purchase_options') {
                                                                                                          echo 'active show';
                                                                                                        } ?>" id="purchase_options">
            <div class="page-title clearfix">
            ...
            <div class="container-fluid mt-3">
              <div class="row">
                <div class="col-md-6">
                  ...
                  <div class="form-group">
                    <div class="checkbox checkbox-primary">
                      <input onchange="purchase_order_setting(this); return false" type="checkbox" id="purchase_order_setting" name="purchase_setting[purchase_order_setting]" <?php if (get_setting('purchase_order_setting') == 1) {
                                                                                                                                                                                  echo 'checked';
                                                                                                                                                                                } ?> value="purchase_order_setting" class="form-check-input">
                  ...
                  <div class="form-group">
                    <div class="checkbox checkbox-primary">
                      <input onchange="item_by_vendor(this); return false" type="checkbox" id="item_by_vendor" name="purchase_setting[item_by_vendor]" <?php if (get_setting('item_by_vendor') == 1) {
                                                                                                                                                          echo 'checked';
                                                                                                                                                        } ?> value="item_by_vendor" class="form-check-input">
                ...
                <div class="col-md-6">
                  <div class="form-group">
                    <div class="checkbox checkbox-primary">
                      <input onchange="show_tax_column(this); return false" type="checkbox" id="show_purchase_tax_column" name="purchase_setting[show_purchase_tax_column]" <?php if (get_setting('show_purchase_tax_column') == 1) {
                                                                                                                                                                              echo 'checked';
                                                                                                                                                                            } ?> value="show_purchase_tax_column" class="form-check-input">
                  ...
                  <div class="form-group">
                    <div class="checkbox checkbox-primary">
                      <input onchange="po_only_prefix_and_number(this); return false" type="checkbox" id="po_only_prefix_and_number" name="purchase_setting[po_only_prefix_and_number]" <?php if (get_setting('po_only_prefix_and_number') == 1) {
                                                                                                                                                                                          echo 'checked';
                                                                                                                                                                                        } ?> value="po_only_prefix_and_number" class="form-check-input">
          ...
          <div role="tabpanel" class="tab-pane fade                                                    <?php if ($group == 'units') {
                                                                                                          echo 'active show';
                                                                                                        } ?>" id="units">
            ...
            <div class="page-title clearfix">
              ...
              <div class="title-button-group">
                <?php echo modal_anchor(get_uri("purchase/modal_unit_form"), "<i data-feather='plus-circle' class='icon-16'></i> " . app_lang('pur_add_unit'), ["class" => "btn btn-default mb1", "title" => app_lang('pur_add_unit')]); ?>
              </div>
            </div>
          ...
          <div role="tabpanel" class="tab-pane fade                                                    <?php if ($group == 'approval') {
                                                                                                          echo 'active show';
                                                                                                        } ?>" id="approval">
            ...
            <div class="page-title clearfix">
              ...
              <div class="title-button-group">
                <?php echo modal_anchor(get_uri("purchase/modal_approval_setting_form"), "<i data-feather='plus-circle' class='icon-16'></i> " . app_lang('pur_add_approval_setting'), ["class" => "btn btn-default mb1 pull-right", "title" => app_lang('pur_add_approval_setting')]); ?>
              </div>
            </div>
          ...
          <div role="tabpanel" class="tab-pane fade                                                    <?php if ($group == 'commodity_group') {
                                                                                                          echo 'active show';
                                                                                                        } ?>" id="commodity_group">
            <div class="page-title clearfix">
              ...
              <div class="title-button-group">
                <?php echo modal_anchor(get_uri("purchase/modal_commodity_group_form"), "<i data-feather='plus-circle' class='icon-16'></i> " . app_lang('pur_add_commodity_group'), ["class" => "btn btn-default mb1", "title" => app_lang('pur_add_commodity_group')]); ?>
              </div>
            </div>
            <div class="table-responsive">
          ...
          <div role="tabpanel" class="tab-pane fade                                                    <?php if ($group == 'sub_group') {
                                                                                                          echo 'active show';
                                                                                                        } ?>" id="sub_group">
            ...
            <div class="page-title clearfix">
              ...
              <div class="title-button-group">
                <?php echo modal_anchor(get_uri("purchase/modal_sub_group_form"), "<i data-feather='plus-circle' class='icon-16'></i> " . app_lang('pur_add_sub_group'), ["class" => "btn btn-default mb1", "title" => app_lang('pur_add_sub_group')]); ?>
              </div>
            </div>
          ...
          <div role="tabpanel" class="tab-pane fade                                                    <?php if ($group == 'vendor_category') {
                                                                                                          echo 'active show';
                                                                                                        } ?>" id="vendor_category">
            <div class="container-fluid mt-3">
            ...
            <div class="page-title clearfix">
              ...
              <div class="title-button-group">
                <?php echo modal_anchor(get_uri("purchase/modal_vendor_category_form"), "<i data-feather='plus-circle' class='icon-16'></i> " . app_lang('pur_add_vendor_category'), ["class" => "btn btn-default mb1", "title" => app_lang('pur_add_vendor_category')]); ?>
              </div>
            </div>
            <div class="table-responsive">
