<div id="page-content" class="page-wrapper clearfix">
	<div class="card clearfix">
		...
		<ul data-bs-toggle="ajax-tab" class="nav nav-tabs bg-white title" role="tablist">
			<li>
				<a href="#tab_pur_invoice" class="<?php if ($tab == 'tab_pur_invoice') {
														echo 'active';
													} ?>" data-bs-target="#tab_pur_invoice" role="presentation">
					<?php echo _l('pur_invoice'); ?>
				</a>
			</li>
			<li>
				<a href="#payment_record" class="<?php if ($tab == 'payment_record') {
														echo 'active';
													} ?>" data-bs-target="#payment_record" role="presentation">
					<?php echo _l('payment_record'); ?>
				</a>
			</li>
			<li>
				<a href="#attachment" class="<?php if ($tab == 'attachment') {
													echo 'active';
												} ?>" data-bs-target="#attachment" role="presentation">
		...
		<div class="tab-content">
			<div role="tabpanel" class="tab-pane ptop10 <?php if ($tab == 'tab_pur_invoice') {
															echo 'active';
														} ?>" id="tab_pur_invoice">
			...
			<div role="tabpanel" class="tab-pane <?php if ($tab == 'payment_record') {
														echo 'active';
													} ?>" id="payment_record">
				<div class="row ml5 mr5">
					<div class="col-md-6 pad_left_0">
			...
			<div role="tabpanel" class="tab-pane <?php if ($tab == 'attachment') {
														echo 'active';
													} ?>" id="attachment">
