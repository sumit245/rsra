		...
		<div class="container-fluid">
			...
			<div class="tab-content mt-3" id="myTabContent">
				<div class="tab-pane fade show active" id="general_infor" role="tabpanel" aria-labelledby="general_infor-tab">
					...
					<!-- Input for Commodity Code and Title -->
					<div class="row">
						<div class="col-md-6">
					...
					<!-- Input for Commodity Barcode, SKU Code and SKU Name -->
					<div class="row">
						<div class="col-md-6">
					...
					<!-- Input for Commodity group and Sub group -->
					<div class="row">
						<div class="col-md-6">
					...
					<!-- Input for Profit, Taxes and Discount -->
					<div class="row">
						<div class="col-md-6">
							<?php
							$attr = array();
					...
					<!-- Input for Purchase price and rate -->
					<div class="row">
						<div class="col-md-6">
							<?php
							$attr = array();
				...
				<div class="tab-pane fade" id="properties" role="tabpanel" aria-labelledby="properties-tab">
					...
					<div class="row">
						...
						<div class="col-md-3 col-sm-6">
							<div class="form-group">
								<div class="checkbox checkbox-primary <?php if (!get_status_modules_pur('manufacturing')) {
																			echo ' hide';
																		} ?>">
