...
$result = data_tables_purchase($aColumns, $sIndexColumn, $sTable, $join, $where, [db_prefix() . 'pur_orders.id as id', 'company', 'pur_order_number', 'expense_convert', db_prefix() . 'projects.title as project_name', db_prefix() . 'team.title as department_name', 'currency'], '', [], $dataPost);
