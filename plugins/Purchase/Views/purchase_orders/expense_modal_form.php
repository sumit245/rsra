<?php echo form_open(get_uri("purchase/add_expense"), array("id" => "expense-form", "class" => "general-form", "role" => "form")); ?>
<div id="expense-dropzone" class="post-dropzone">
    <div class="modal-body clearfix">
        <div class="container-fluid">
            ...
            <input type="hidden" name="pur_order_id" value="<?php echo html_entity_decode($model_info->pur_order_id); ?>" />
            ...
            <?php if ($login_user->is_admin || $can_access_clients && $can_access_expenses) { ?>
                ...
                <?php if ($client_id) { ?>
                    <input type="hidden" name="expense_client_id" value="<?php echo html_entity_decode($client_id); ?>" />
                <?php } else { ?>
                    <div class="form-group">
                        <div class="row">
    ...
    <div class="modal-footer">
        <button class="btn btn-default upload-file-button float-start btn-sm round me-auto" type="button"><i data-feather="camera" class="icon-14"></i> <?php echo app_lang("upload_file"); ?></button>
