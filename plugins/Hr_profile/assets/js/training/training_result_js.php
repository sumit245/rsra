<script>
	...
	initDataTable(table_training_result, "<?php echo get_uri("hr_profile/table_training_result") ?>", [0], [0], TrainingProgramServerParams, [0, 'desc']);
	...
	$('#staff').on('change', function() {
		table_training_result.DataTable().ajax.reload();
	});
