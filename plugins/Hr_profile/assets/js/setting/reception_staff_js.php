<script>
	...
	function add_title(el){
		...
		html+='<button onclick="remove_title(this); return false;" class="btn btn-danger mt-1" data-ticket="true" type="button"><span data-feather="x" class="icon-16"></span></button>';
		html+='</div>';
		...
		html+='<span data-feather="plus-circle" class="icon-16"></button>';
		html+='</div>';
		html+='</div></div>';
		html+='</div>';
	...
	function add_subtitle(el){
		...
		var html='<div class="sub row"><div class="col-md-10 pt-2">';
		html+='<div class="form-group">';
		...
		html+='</div>';
		html+='<div class="col-md-2 pl-0 pt-0" name="button_add">';
		html+='<button onclick="remove_subtitle(this); return false;" class="btn btn-danger mt-1" data-ticket="true" type="button"><span data-feather="x" class="icon-16"></span></button>';
		html+='</div></div>';
	...
	$("body").on('click', '.new_assets_emp', function() {
		...
		new_assets_emp.find('button[name="add_asset"] svg').removeClass('feather-plus-circle').addClass('feather-x');
		new_assets_emp.find('button[name="add_asset"] svg').html('');
		new_assets_emp.find('button[name="add_asset"] svg').html('<line x1="18" y1="6" x2="6" y2="18"></line><line x1="6" y1="6" x2="18" y2="18"></line>');
