<script>
	...
	function init_report(e, type) {
	 ...
	 function hr_is_working(){
	 	...
	 	$.post("<?php echo get_uri("hr_profile/HR_is_working") ?>", data).done(function(response) {
	 ...
	 function qualifications_department(){
	 	...
	 	$.post("<?php echo get_uri("hr_profile/qualification_department") ?>", data).done(function(response) {
	 		response = JSON.parse(response);
...
function report_the_employee_quitting(){
	...
	initDataTable('.table-report_the_employee_quitting', "<?php echo get_uri("hr_profile/table_report_the_employee_quitting") ?>", [0], [0], fnServerParams, [0, 'desc']);
...
function list_of_employees_with_salary_change(){ 
	...
	initDataTable('.table-list_of_employees_with_salary_change', "<?php echo get_uri("hr_profile/table_list_of_employees_with_salary_change") ?>", [0], [0], fnServerParams, [0, 'desc']);
	//hide first column
	var hidden_columns = [0];
