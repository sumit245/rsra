...
$file_header = array();
$file_header[] = app_lang('hr_contract_code');
$file_header[] = app_lang('hr_hr_code');
$file_header[] = app_lang('_id_contract_name');
$file_header[] = app_lang('hr_contract_form');
$file_header[] = app_lang('start_valid');
$file_header[] = app_lang('end_valid');
$file_header[] = app_lang('contract_status');

$file_header[] = app_lang('_effective_date_salary_allowance');

$file_header[] = app_lang('hr_sign_day');
$file_header[] = app_lang('hr_staff_delegate');
			...
			<div class="col-md-12">
				<div class="panel_s">
					<div class="panel-body">
						...
						<a href="<?= site_url('hr_profile/write_xlsx_contract_sample') ?>" class="btn btn-secondary-color2" ><?php echo app_lang('hr_download_sample') ?></a>
						<hr>

						<?php if(!isset($simulate)) { ?>
							<ul>
								<li>1. <?php echo app_lang('hr_import_excel_1'); ?></li>
								<li class="text-danger">2. <?php echo app_lang('file_xlsx_hrm_contract'); ?></li>
							</ul>
						...
						<div class="row">
							<div class="col-md-4">
								...
								<div class="form-group">
									<button id="uploadfile" type="button" class="btn btn-info import" onclick="return uploadfilecsv();" ><?php echo app_lang('import'); ?></button>
								</div>
								<?php echo form_close(); ?>
							</div>
							<div class="col-md-8">
