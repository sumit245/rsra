	...
	<div class="modal-dialog modal-lg">
		<div class="modal-content">
			<div class="modal-header">
				...
				$staffid = '';
				if(isset($member)){
					$title .= app_lang('hr_update_permissions');
					$staffid    = $member->staffid;
				}else{
					$title .= app_lang('hr_add_permissions');
				}
				?>
				...
				<div class="table-responsive">
					...
					<?php if(isset($member)){ 
						...
						<div class="lable-display-name">
							<?php echo render_input('staff_name', 'hr_hr_staff_name', get_staff_full_name1($member->staffid), '', $staff_attr); ?>
