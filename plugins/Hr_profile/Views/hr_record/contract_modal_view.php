    ...
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            ...
            <div class="modal-body">
                      ...
                      <table class="table border table-striped ">
                        <tbody>
                            <tr class="project-overview">
                              <td class="bold" ><?php echo app_lang('hr_contract_code'); ?></td>
                              <td><?php echo html_entity_decode($contract->contract_code); ?></td>
                            </tr>
                             <tr class="project-overview">
                              <td class="bold"><?php echo app_lang('hr_start_month'); ?></td>
                              <td><?php echo _d($contract->start_valid); ?></td>
                            </tr>
                              
                              <tr class="project-overview">
                                  <td class="bold"><?php echo app_lang('hr_end_month'); ?></td>
                                  <td><?php echo _d($contract->end_valid); ?></td>
                              </tr>
                              <tr class="project-overview">
                                  <td class="bold" ><?php echo app_lang('hr_sign_day'); ?></td>
                                  <td><?php echo _d($contract->sign_day); ?></td>
                              </tr>
                              <tr class="project-overview">
                                <td class="bold"><?php echo app_lang('hr_hourly_rate_month'); ?></td>
                                <td ><?php echo app_lang($contract->hourly_or_month); ?></td>
                              </tr>
                        </tbody>
                        </table>
                    </div>
                ...
                <h5><?php echo app_lang('hr_hr_contract_rel_type') ?></h5>
                <div class="row">
                    <div class="col-md-12">
                        <table class="table border table-striped ">
                           <thead>
