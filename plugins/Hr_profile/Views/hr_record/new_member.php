							...
							<div class="col-md-12">
								<div class="picture-container float-start">
									<div class="picture pull-left">
										<img src="<?php if (isset($image_exist) && isset($link_cover_image)) {
														echo  html_entity_decode($link_cover_image ?? "");
													} else {
								...
								<div class="col-md-6">
									<div class="form-group">
										...
										<select name="gender" class="select2 validate-hidden" id="gender" data-width="100%" data-none-selected-text="<?php echo app_lang('dropdown_non_selected_tex'); ?>">
											<option value=""></option>
											<option value="male" <?php if (isset($member) && $member->gender == 'male') {
																		echo 'selected';
																	} ?>><?php echo app_lang('male'); ?></option>
											<option value="female" <?php if (isset($member) && $member->gender == 'female') {
																		echo 'selected';
																	} ?>><?php echo app_lang('female'); ?></option>
										</select>
									</div>
								</div>
								...
								<div class="col-md-6">
									<div class="form-group">
										...
										<div class="input-group">
											<input type="number" name="hourly_rate" step="any" value="<?php if (isset($member)) {
								...
								<div class="form-group">
									<div class="row">
										<div class="col-md-12">
											...
											echo render_textarea1('orther_infor', 'hr_orther_infor', $orther_infor); ?>
										</div>
									</div>
								...
								<div class="col-md-6">
									<div class="form-group">
										...
										<select name="marital_status" class="select2 validate-hidden" id="marital_status" data-width="100%" data-none-selected-text="<?php echo app_lang('dropdown_non_selected_tex'); ?>">
											<option value="">-</option>
											<option value="single" <?php if (isset($member) && $member->marital_status == 'single') {
																		echo 'selected';
																	} ?>><?php echo app_lang('hr_single'); ?></option>
											<option value="married" <?php if (isset($member) && $member->marital_status == 'married') {
																		echo 'selected';
																	} ?>><?php echo app_lang('hr_married'); ?></option>
										</select>
									</div>
								</div>
							...
							<div class="row">
								<div class="col-md-6">
									<div class="form-group">
										...
										<input type="text" class="form-control" placeholder="https://www.facebook.com/" name="facebook" value="<?php if (isset($social_link)) {
																																					echo html_entity_decode($social_link->facebook);
																																				} ?>">
									</div>
								</div>
								<div class="col-md-6">
									<div class="form-group">
										...
										<input type="text" class="form-control" placeholder="https://www.linkedin.com" name="linkedin" value="<?php if (isset($social_link)) {
																																					echo html_entity_decode($social_link->linkedin);
																																				} ?>">
									</div>
								</div>
							</div>
							...
							<div class="row">
								<div class="col-md-6">
									<div class="form-group">
										...
										<input type="text" class="form-control" placeholder="https://twitter.com/" name="twitter" value="<?php if (isset($social_link)) {
																																				echo html_entity_decode($social_link->twitter);
																																			} ?>">
									</div>
								</div>
								<div class="col-md-6">
									<div class="form-group">
										...
										<input type="text" class="form-control" name="whatsapp" placeholder="https://wa.me/+001XXXXXXX" value="<?php if (isset($social_link)) {
																																					echo html_entity_decode($social_link->whatsapp ?? "");
																																				} ?>">
									</div>
								</div>
							</div>
							...
							<div class="row">
								...
								<div class="col-md-6">
									<div class="form-group">
										...
										<input type="text" class="form-control" name="digg" placeholder="http://digg.com/" value="<?php if (isset($social_link)) {
																																		echo html_entity_decode($social_link->digg ?? "");
																																	} ?>">
									</div>
								</div>
							</div>
							<div class="row">
								<div class="col-md-6">
									<div class="form-group">
										...
										<input type="text" class="form-control" name="youtube" placeholder="https://www.youtube.com/" value="<?php if (isset($social_link)) {
																																					echo html_entity_decode($social_link->youtube ?? "");
																																				} ?>">
									</div>
								</div>
								<div class="col-md-6">
									<div class="form-group">
										...
										<input type="text" class="form-control" name="pinterest" placeholder="https://www.pinterest.com/" value="<?php if (isset($social_link)) {
																																						echo html_entity_decode($social_link->pinterest ?? "");
																																					} ?>">
									</div>
								</div>
							</div>
							<div class="row">
								<div class="col-md-6">
									<div class="form-group">
										...
										<input type="text" class="form-control" name="instagram" placeholder="https://instagram.com/" value="<?php if (isset($social_link)) {
																																					echo html_entity_decode($social_link->instagram ?? "");
																																				} ?>">
									</div>
								</div>
								<div class="col-md-6">
									<div class="form-group">
										...
										<input type="text" class="form-control" name="github" placeholder="https://github.com/" value="<?php if (isset($social_link)) {
																																			echo html_entity_decode($social_link->github ?? "");
																																		} ?>">
									</div>
								</div>
							</div>
							<div class="row">
								<div class="col-md-6">
									<div class="form-group">
										...
										<input type="text" class="form-control" name="tumblr" placeholder="https://www.tumblr.com/" value="<?php if (isset($social_link)) {
																																				echo html_entity_decode($social_link->tumblr ?? "");
																																			} ?>">
									</div>
								</div>
								<div class="col-md-6">
									<div class="form-group">
										...
										<input type="text" class="form-control" name="vine" placeholder="https://vine.co/" value="<?php if (isset($social_link)) {
																																		echo html_entity_decode($social_link->vine ?? "");
																																	} ?>">
									</div>
								</div>
							</div>
