	...
	<div class="modal-dialog modal-lg">
		<div class="modal-content">
			<div class="modal-header">
				...
				$staffid = '';
				if (isset($member)) {
					$title .= app_lang('hr_update_staff_profile');
					...
					$title .= app_lang('add_staff_profile');
			...
			<div class="modal-body">
				<ul class="nav nav-tabs" role="tablist">
					<li role="presentation" class="active">
						<a href="#tab_staff_profile" aria-controls="tab_staff_profile" role="tab" data-toggle="tab">
							<?php echo app_lang('staff_profile_string'); ?>
						</a>
					</li>
					<li role="presentation">
						<a href="#tab_staff_contact" aria-controls="tab_staff_contact" role="tab" data-toggle="tab">
							<?php echo app_lang('hr_staff_profile_related_info'); ?>
						</a>
					</li>
				...
				<div class="tab-content">
					...
					<div role="tabpanel" class="tab-pane active" id="tab_staff_profile">
						...
						<?php if (total_rows(db_prefix() . 'emailtemplates', array('slug' => 'two-factor-authentication', 'active' => 0)) == 0) {?>
							<div class="checkbox checkbox-primary">
								...
								<label for="two_factor_auth_enabled"><i class="fa fa-question-circle" data-toggle="tooltip" data-title="<?php echo app_lang('two_factor_authentication_info'); ?>"></i>
									<?php echo app_lang('enable_two_factor_authentication'); ?></label>
								</div>
							<?php }?>
							...
							<div class="row">
								...
								<div class="col-md-12">
									...
									<div class="form-group" app-field-wrapper="staff_identifi">
										<label for="staff_identifi" class="control-label"><?php echo app_lang('hr_staff_code'); ?></label>
										<input type="text" id="staff_identifi" name="staff_identifi" class="form-control" value="<?php echo html_entity_decode($hr_codes) ?>" aria-invalid="false" <?php if (!is_admin() && !hr_has_permission('hr_profile_can_edit_hr_records') && !hr_has_permission('hr_profile_can_create_hr_records')) {echo 'disabled';}?>>
									</div>
								</div>
							...
							<div class="row">
								<div class="col-md-6">
									<div class="form-group">
										<label for="sex" class="control-label"><?php echo app_lang('hr_sex'); ?></label>
										<select name="sex" class="selectpicker" id="sex" data-width="100%" data-none-selected-text="<?php echo app_lang('dropdown_non_selected_tex'); ?>">
											<option value=""></option>
											<option value="<?php echo 'male'; ?>" <?php if (isset($member) && $member->sex == 'male') {echo 'selected';}?>><?php echo app_lang('male'); ?></option>
											<option value="<?php echo 'female'; ?>" <?php if (isset($member) && $member->sex == 'female') {echo 'selected';}?>><?php echo app_lang('female'); ?></option>
										</select>
									</div>
								</div>
							...
							<div class="row">
								<div class="col-md-6">
									...
									<div class="form-group" app-field-wrapper="email">
										...
										<input type="email" id="email" name="email" class="form-control" autocomplete="off" value="<?php echo html_entity_decode($value) ?>" <?php if (!is_admin() && !hr_has_permission('hr_profile_can_edit_hr_records') && !hr_has_permission('hr_profile_can_create_hr_records')) {echo 'disabled';}?>>
									</div>
								</div>
							...
							<div class="row">
								<div class="col-md-6">
									<div class="form-group">
										...
										<select name="workplace" class="selectpicker" id="workplace" data-width="100%" data-none-selected-text="<?php echo app_lang('dropdown_non_selected_tex'); ?>">
											<option value=""></option>
								...
								<div class="col-md-6">
									<div class="form-group">
										<label for="status_work" class="control-label"><?php echo app_lang('hr_status_work'); ?></label>
										<select name="status_work" class="selectpicker" id="status_work" data-width="100%" data-none-selected-text="<?php echo app_lang('dropdown_non_selected_tex'); ?>">
											<option value="<?php echo 'working'; ?>" <?php if (isset($member) && $member->status_work == 'working') {echo 'selected';}?>><?php echo app_lang('hr_working'); ?></option>
											<option value="<?php echo 'maternity_leave'; ?>" <?php if (isset($member) && $member->status_work == 'maternity_leave') {echo 'selected';}?>><?php echo app_lang('hr_maternity_leave'); ?></option>
											<option value="<?php echo 'inactivity'; ?>" <?php if (isset($member) && $member->status_work == 'inactivity') {echo 'selected';}?>><?php echo app_lang('hr_inactivity'); ?></option>
										</select>
									</div>
								</div>
							</div>
							...
							<div class="row">
								<div class="col-md-6">
									<div class="form-group">
										...
										<select name="job_position" class="selectpicker" id="job_position" data-width="100%"  data-action-box="true" data-hide-disabled="true" data-live-search="true" data-none-selected-text="<?php echo app_lang('dropdown_non_selected_tex'); ?>">
											<option value=""></option>
								...
								<div class="col-md-6">
									<!--teamanage -->
									<?php if (hr_has_permission('hr_profile_can_edit_hr_records') || hr_has_permission('hr_profile_can_create_hr_records')) {?>
							...
							<?php if (is_admin() || hr_has_permission('hr_profile_can_edit_hr_records')) {
								?>
								<?php
							...
							<div class="row">
								<div class="col-md-6">
									...
									<div class="form-group">
										...
										<select name="literacy" id="literacy" class="selectpicker" data-width="100%" data-none-selected-text="<?php echo app_lang('hr_not_required'); ?>">
											<option value=""></option>
							...
							<div class="row">
								<div class="col-md-6">
									<?php if (get_option('disable_language') == 0) {
										?>
										<div class="form-group">
											<label for="default_language" class="control-label"><?php echo app_lang('localization_default_language'); ?></label>
											<select name="default_language" data-live-search="true" id="default_language" class="form-control selectpicker" data-none-selected-text="<?php echo app_lang('dropdown_non_selected_tex'); ?>">
												<option value=""><?php echo app_lang('system_default_string'); ?></option>
								...
								<div class="col-md-6">
									<div class="form-group">
										<label for="direction"><?php echo app_lang('document_direction'); ?></label>
										<select class="selectpicker" data-none-selected-text="<?php echo app_lang('system_default_string'); ?>" data-width="100%" name="direction" id="direction">
							...
							<?php if (is_admin() || hr_has_permission('hr_profile_can_edit_hr_records')) {
								...
								<div class="form-group">
									<div class="row">
										<div class="col-md-6">
											<i class="fa fa-question-circle pull-left" data-toggle="tooltip" data-title="<?php echo app_lang('staff_email_signature_help'); ?>"></i>
									...
									<?php if (count($departments) > 0) {?>
										<label for="departments"><?php echo app_lang('staff_add_edit_departments'); ?></label>
									<?php }?>
								...
								<div class="col-md-12">
									...
									<?php if (!isset($member) && total_rows(db_prefix() . 'emailtemplates', array('slug' => 'new-staff-created', 'active' => 0)) === 0) {?>
										<div class="checkbox checkbox-primary">
											...
											<label for="send_welcome_email"><?php echo app_lang('staff_send_welcome_email'); ?></label>
										</div>
									<?php }?>
								</div>
							</div>
							...
							<?php if (!isset($member) || is_admin() || !is_admin() && $member->admin == 0) {?>
								...
								<label for="password" class="control-label"><?php echo app_lang('staff_add_edit_password'); ?></label>
								<div class="input-group">
								...
								<?php if (isset($member)) {?>
									<p class="text-muted"><?php echo app_lang('staff_add_edit_password_note'); ?></p>
									<?php if ($member->last_password_change != NULL) {?>
										<?php echo app_lang('staff_add_edit_password_last_changed'); ?>:
							...
							<div role="tabpanel" class="tab-pane " id="tab_staff_contact">
								...
								<div class="row">
									...
									<div class="col-md-6">
										<div class="form-group">
											...
											<select name="marital_status" class="selectpicker" id="marital_status" data-width="100%" data-none-selected-text="<?php echo app_lang('dropdown_non_selected_tex'); ?>">
												<option value=""></option>
												<option value="<?php echo 'single'; ?>" <?php if (isset($member) && $member->marital_status == 'single') {echo 'selected';}?>><?php echo app_lang('hr_single'); ?></option>
												<option value="<?php echo 'married'; ?>" <?php if (isset($member) && $member->marital_status == 'married') {echo 'selected';}?>><?php echo app_lang('married'); ?></option>
											</select>
										</div>
									</div>
								...
								<div class="row">
									<div class="col-md-6">
										<div class="form-group">
											<label for="facebook" class="control-label"><i class="fa fa-facebook"></i> <?php echo app_lang('staff_add_edit_facebook'); ?></label>
											<input type="text" class="form-control" name="facebook" value="<?php if (isset($member)) {echo html_entity_decode($member->facebook);}?>">
										</div>
									</div>
									<div class="col-md-6">
										<div class="form-group">
											<label for="linkedin" class="control-label"><i class="fa fa-linkedin"></i> <?php echo app_lang('staff_add_edit_linkedin'); ?></label>
								...
								<div class="row">
									<div class="col-md-6">
										<div class="form-group">
											<label for="skype" class="control-label"><i class="fa fa-skype"></i> <?php echo app_lang('staff_add_edit_skype'); ?></label>
					...
					<div class="modal-footer">
						<button type="button" class="btn btn-default close_btn" data-dismiss="modal"><?php echo app_lang('hr_close'); ?></button>
						<button type="submit" class="btn btn-info"><?php echo app_lang('submit'); ?></button>
					</div>
					<?php echo form_close(); ?>
				</div><!-- /.modal-content -->
