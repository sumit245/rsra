 ...
 <div>
 	<div id="contract_attachments" class="mtop30 col-md-8 col-md-offset-2">
 		...
 		foreach($hr_profile_staff as $attachment) {
 			...
 			$data .= '<a name="preview-btn" onclick="preview_file_staff(this); return false;" rel_id = "'.$attachment['rel_id'].'" id = "'.$attachment['id'].'" href="Javascript:void(0);" class="mbot10 btn btn-success pull-left" data-toggle="tooltip" title data-original-title="'.app_lang("preview_file").'">';
 			...
 			if($attachment['staffid'] == get_staff_user_id() || is_admin() || hr_has_permission('hr_profile_can_edit_hr_records')){
