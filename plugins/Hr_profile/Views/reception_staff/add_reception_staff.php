<div id="page-content" class="page-wrapper clearfix">
	<div class="row">
		<div class="col-sm-12 col-lg-12">
			<?php echo form_open_multipart(get_uri("hr_profile/add_new_reception"), array("id" => "add_new_reception", "class" => "general-form", "role" => "form")); ?>
			<div class="card">
				...
				<div class="modal-body clearfix">
					...
					<div class="col-md-12">
						...
						<select name="staff_id" data-live-search="true" class="select2 validate-hidden" id="staff_id" data-width="100%" placeholder="<?php echo app_lang('dropdown_non_selected_tex'); ?>" required="1"> 
												...
												<div class="row">
													<div class="col-md-10">
														<div class="form-group">
															<input type="text" name="title_name[<?php echo html_entity_decode($key); ?>]" class="form-control" placeholder="<?php echo app_lang('hr_title'); ?>" value="<?php echo html_entity_decode($value['group_name']); ?>" required="1">
														</div>
													</div>
												...
												foreach ($checklist as $ind => $sub_item) {?>
													<div class="sub"> 
														<div class="row">                          
															<div class="col-md-9">
																<div class="form-group">
																	<input type="text" name="sub_title_name[<?php echo html_entity_decode($key); ?>][<?php echo html_entity_decode($ind); ?>]" data-count="<?php echo html_entity_decode($key); ?>" class="form-control" value="<?php echo html_entity_decode($sub_item['name']); ?>" placeholder="<?php echo app_lang('hr_sub_title'); ?>" required="1">
																</div>
															</div>
									...
									<div class="col-md-12 assets_wrap">
												...
												<div id ="assets_emp" class="row">                            
													<div class="col-md-11 pt-2">
														<div class="form-group">
															...
															?>
															<input type="text" name="asset_name[]" class="form-control" value="<?php echo html_entity_decode($name); ?>" placeholder="<?php echo app_lang('hr_enter_property_name'); ?>" required="1">
														</div>
													</div>                            
													<div class="col-md-1 pl-0 pt-0" name="button_add">
														<?php if($p_key == 0){ ?>
										...
										<?php }else{ ?>
											<div id ="assets_emp" class="row">                           
												<div class="col-md-11 pt-2">
													<div class="form-group">                
														<input type="text" name="asset_name[]" class="form-control" value="" placeholder="<?php echo app_lang('hr_enter_property_name'); ?>" required="1">
													</div>
												</div>
												<div class="col-md-1 pl-0 pt-0" name="button_add">
								...
								<div class="row">
									<div class="col-md-12 ">
										<div class="form-group">
											...
											<select name="training_program" class="select2 validate-hidden" id="training_program" data-width="100%" placeholder="<?php echo app_lang('dropdown_non_selected_tex'); ?>" required="1" data-rule-required="1">
												<option value="" selected="selected">-</option>
											</select>
										</div>
									</div>
					...
					<div class="container-fluid">
						<div class="">
							<div class="btn-bottom-toolbar text-right mb20 mt20">
								<a href="<?php echo get_uri('hr_profile/reception_staff'); ?>"class="btn btn-default text-right mright5"><span data-feather="x" class="icon-16"></span> <?php echo app_lang('close'); ?></a>

								<?php if(hr_has_permission('hr_profile_can_create_onboarding') || hr_has_permission('hr_profile_can_edit_onboarding')){ ?>
