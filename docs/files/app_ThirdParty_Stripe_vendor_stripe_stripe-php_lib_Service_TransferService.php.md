...
- Path: `app\ThirdParty\Stripe\vendor\stripe\stripe-php\lib\Service\TransferService.php`
- Type: PHP
- Size: 5951 bytes
...
**Classes**:
- `Stripe\Service\TransferService extends \Stripe\Service\AbstractService`

**Functions/Methods**:
- `all($params = null, $opts = null)`
- `allReversals($parentId, $params = null, $opts = null)`
- `create($params = null, $opts = null)`
- `createReversal($parentId, $params = null, $opts = null)`
- `retrieve($id, $params = null, $opts = null)`
- `retrieveReversal($parentId, $id, $params = null, $opts = null)`
- `update($id, $params = null, $opts = null)`
- `updateReversal($parentId, $id, $params = null, $opts = null)`
