...
- Path: `app\ThirdParty\PHPOffice-PhpSpreadsheet\vendor\ezyang\htmlpurifier\library\HTMLPurifier\Strategy\FixNesting.php`
- Type: PHP
- Size: 7557 bytes
...
**Classes**:
- `HTMLPurifier_Strategy_FixNesting extends HTMLPurifier_Strategy`
