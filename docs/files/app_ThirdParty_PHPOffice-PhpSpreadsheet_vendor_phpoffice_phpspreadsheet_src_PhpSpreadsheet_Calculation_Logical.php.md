...
- Path: `app\ThirdParty\PHPOffice-PhpSpreadsheet\vendor\phpoffice\phpspreadsheet\src\PhpSpreadsheet\Calculation\Logical.php`
- Type: PHP
- Size: 11747 bytes
...
**Classes**:
- `PhpOffice\PhpSpreadsheet\Calculation\Logical`
