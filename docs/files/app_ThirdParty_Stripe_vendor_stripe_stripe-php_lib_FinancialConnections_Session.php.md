...
- Path: `app\ThirdParty\Stripe\vendor\stripe\stripe-php\lib\FinancialConnections\Session.php`
- Type: PHP
- Size: 1465 bytes
...
**Classes**:
- `Stripe\FinancialConnections\Session extends \Stripe\ApiResource`
