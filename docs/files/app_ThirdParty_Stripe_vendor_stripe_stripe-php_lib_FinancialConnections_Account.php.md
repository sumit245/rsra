...
- Path: `app\ThirdParty\Stripe\vendor\stripe\stripe-php\lib\FinancialConnections\Account.php`
- Type: PHP
- Size: 5058 bytes
...
**Classes**:
- `Stripe\FinancialConnections\Account extends \Stripe\ApiResource`

**Functions/Methods**:
- `disconnect($params = null, $opts = null)`
- `allOwners($id, $params = null, $opts = null)`
- `refreshAccount($params = null, $opts = null)`
