...
- Path: `app\ThirdParty\Stripe\vendor\stripe\stripe-php\lib\Service\ApplicationFeeService.php`
- Type: PHP
- Size: 4778 bytes
...
**Classes**:
- `Stripe\Service\ApplicationFeeService extends \Stripe\Service\AbstractService`

**Functions/Methods**:
- `all($params = null, $opts = null)`
- `allRefunds($parentId, $params = null, $opts = null)`
- `createRefund($parentId, $params = null, $opts = null)`
- `retrieve($id, $params = null, $opts = null)`
- `retrieveRefund($parentId, $id, $params = null, $opts = null)`
- `updateRefund($parentId, $id, $params = null, $opts = null)`
