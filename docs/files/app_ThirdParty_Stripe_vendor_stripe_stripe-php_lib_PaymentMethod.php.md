...
- Path: `app\ThirdParty\Stripe\vendor\stripe\stripe-php\lib\PaymentMethod.php`
- Type: PHP
- Size: 4389 bytes
...
**Classes**:
- `Stripe\PaymentMethod extends ApiResource`

**Functions/Methods**:
- `attach($params = null, $opts = null)`
- `detach($params = null, $opts = null)`
