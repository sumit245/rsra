...
- Path: `app\ThirdParty\Stripe\vendor\stripe\stripe-php\lib\Issuing\Authorization.php`
- Type: PHP
- Size: 5651 bytes
...
**Classes**:
- `Stripe\Issuing\Authorization extends \Stripe\ApiResource`

**Functions/Methods**:
- `approve($params = null, $opts = null)`
- `decline($params = null, $opts = null)`
