...
- Path: `app\ThirdParty\PHPOffice-PhpSpreadsheet\vendor\phpoffice\phpspreadsheet\src\PhpSpreadsheet\Calculation\DateTime.php`
- Type: PHP
- Size: 35518 bytes
...
- `DATEVALUE($dateValue)`
- `TIMEVALUE($timeValue)`
- `DATEDIF($startDate = 0, $endDate = 0, $unit = 'D')`
- `DAYS($endDate = 0, $startDate = 0)`
- `DAYS360($startDate = 0, $endDate = 0, $method = false)`
- `YEARFRAC($startDate = 0, $endDate = 0, $method = 0)`
- `NETWORKDAYS($startDate, $endDate, ...$dateArgs)`
- `WORKDAY($startDate, $endDays, ...$dateArgs)`
- `DAYOFMONTH($dateValue = 1)`
- `WEEKDAY($dateValue = 1, $style = 1)`
- `WEEKNUM($dateValue = 1, $method = self::STARTWEEK_SUNDAY)`
- `ISOWEEKNUM($dateValue = 1)`
- `MONTHOFYEAR($dateValue = 1)`
- `YEAR($dateValue = 1)`
- `HOUROFDAY($timeValue = 0)`
- `MINUTE($timeValue = 0)`
- `SECOND($timeValue = 0)`
- `EDATE($dateValue = 1, $adjustmentMonths = 0)`
- `EOMONTH($dateValue = 1, $adjustmentMonths = 0)`
