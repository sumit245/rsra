...
- Path: `app\ThirdParty\PHPOffice-PhpSpreadsheet\vendor\phpoffice\phpspreadsheet\src\PhpSpreadsheet\Calculation\LookupRef.php`
- Type: PHP
- Size: 16580 bytes
...
**Functions/Methods**:
- `cellAddress($row, $column, $relativity = 1, $referenceStyle = true, $sheetText = '')`
- `COLUMN($cellAddress = null, ?Cell $cell = null)`
- `COLUMNS($cellAddress = null)`
- `ROW($cellAddress = null, ?Cell $cell = null)`
- `ROWS($cellAddress = null)`
- `HYPERLINK($linkURL = '', $displayName = null, ?Cell $cell = null)`
- `INDIRECT($cellAddress, Cell $cell)`
...
- `VLOOKUP($lookup_value, $lookup_array, $index_number, $not_exact_match = true)`
- `HLOOKUP($lookup_value, $lookup_array, $index_number, $not_exact_match = true)`
- `LOOKUP($lookup_value, $lookup_vector, $result_vector = null)`
- `FORMULATEXT($cellReference = '', ?Cell $cell = null)`
