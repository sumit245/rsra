...
- Path: `app\ThirdParty\Stripe\vendor\stripe\stripe-php\lib\Checkout\Session.php`
- Type: PHP
- Size: 9792 bytes
...
**Classes**:
- `Stripe\Checkout\Session extends \Stripe\ApiResource`

**Functions/Methods**:
- `expire($params = null, $opts = null)`
