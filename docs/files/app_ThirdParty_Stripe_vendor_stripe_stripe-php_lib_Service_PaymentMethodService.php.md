...
- Path: `app\ThirdParty\Stripe\vendor\stripe\stripe-php\lib\Service\PaymentMethodService.php`
- Type: PHP
- Size: 5267 bytes
...
**Classes**:
- `Stripe\Service\PaymentMethodService extends \Stripe\Service\AbstractService`

**Functions/Methods**:
- `all($params = null, $opts = null)`
- `attach($id, $params = null, $opts = null)`
- `create($params = null, $opts = null)`
- `detach($id, $params = null, $opts = null)`
