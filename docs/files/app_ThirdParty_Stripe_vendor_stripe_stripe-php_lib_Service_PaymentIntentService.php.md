...
- Path: `app\ThirdParty\Stripe\vendor\stripe\stripe-php\lib\Service\PaymentIntentService.php`
- Type: PHP
- Size: 11826 bytes
...
**Classes**:
- `Stripe\Service\PaymentIntentService extends \Stripe\Service\AbstractService`

**Functions/Methods**:
- `all($params = null, $opts = null)`
- `applyCustomerBalance($id, $params = null, $opts = null)`
...
- `incrementAuthorization($id, $params = null, $opts = null)`
