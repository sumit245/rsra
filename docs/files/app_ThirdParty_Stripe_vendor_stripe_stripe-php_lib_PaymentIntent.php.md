...
- Path: `app\ThirdParty\Stripe\vendor\stripe\stripe-php\lib\PaymentIntent.php`
- Type: PHP
- Size: 13954 bytes
...
**Classes**:
- `Stripe\PaymentIntent extends ApiResource`

**Functions/Methods**:
- `applyCustomerBalance($params = null, $opts = null)`
- `cancel($params = null, $opts = null)`
- `capture($params = null, $opts = null)`
- `confirm($params = null, $opts = null)`
- `incrementAuthorization($params = null, $opts = null)`
- `verifyMicrodeposits($params = null, $opts = null)`
