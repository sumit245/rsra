...
- Path: `app\ThirdParty\Stripe\vendor\stripe\stripe-php\lib\Issuing\Dispute.php`
- Type: PHP
- Size: 2724 bytes
...
**Classes**:
- `Stripe\Issuing\Dispute extends \Stripe\ApiResource`

**Functions/Methods**:
- `submit($params = null, $opts = null)`
