...
- Path: `app\ThirdParty\Imap\mail-mime-parser\vendor\zbateson\mail-mime-parser\src\Message\Part\ParentHeaderPart.php`
- Type: PHP
- Size: 7772 bytes
...
**Classes**:
- `ZBateson\MailMimeParser\Message\Part\ParentHeaderPart extends ParentPart`
...
- `getHeader($name, $offset = 0)`
- `getAllHeaders()`
- `getAllHeadersByName($name)`
- `getRawHeaders()`
- `getRawHeaderIterator()`
- `getHeaderValue($name, $defaultValue = null)`
- `getHeaderParameter($header, $param, $defaultValue = null)`
- `setRawHeader($name, $value, $offset = 0)`
- `addRawHeader($name, $value)`
- `removeHeader($name)`
- `removeSingleHeader($name, $offset = 0)`
