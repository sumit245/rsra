...
- Path: `plugins\Purchase\Helpers\purchase_datatables_helper.php`
- Type: PHP
- Size: 14950 bytes
...
- `data_tables_purchase($aColumns, $sIndexColumn, $sTable, $join = [], $where = [], $additionalSelect = [], $sGroupBy = '', $searchAs = [], $dataPost = [])`
- `get_purchase_requests($aColumns, $sIndexColumn, $sTable, $join = [], $where = [], $additionalSelect = [], $sGroupBy = '', $searchAs = [], $dataPost = [])`
