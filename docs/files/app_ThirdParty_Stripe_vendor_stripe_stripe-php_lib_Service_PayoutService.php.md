...
- Path: `app\ThirdParty\Stripe\vendor\stripe\stripe-php\lib\Service\PayoutService.php`
- Type: PHP
- Size: 4690 bytes
...
**Classes**:
- `Stripe\Service\PayoutService extends \Stripe\Service\AbstractService`
...
- `reverse($id, $params = null, $opts = null)`
