...
- Path: `app\ThirdParty\Stripe\vendor\stripe\stripe-php\lib\Identity\VerificationSession.php`
- Type: PHP
- Size: 5195 bytes
...
**Classes**:
- `Stripe\Identity\VerificationSession extends \Stripe\ApiResource`

**Functions/Methods**:
- `cancel($params = null, $opts = null)`
- `redact($params = null, $opts = null)`
