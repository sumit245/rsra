...
- Path: `app\ThirdParty\Stripe\vendor\stripe\stripe-php\lib\Service\DisputeService.php`
- Type: PHP
- Size: 2881 bytes
...
**Classes**:
- `Stripe\Service\DisputeService extends \Stripe\Service\AbstractService`

**Functions/Methods**:
- `all($params = null, $opts = null)`
- `close($id, $params = null, $opts = null)`
