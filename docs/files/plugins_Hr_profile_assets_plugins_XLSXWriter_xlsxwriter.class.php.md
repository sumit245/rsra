...
- Path: `plugins\Hr_profile\assets\plugins\XLSXWriter\xlsxwriter.class.php`
- Type: PHP
- Size: 51600 bytes
...
- `writeSheetHeader_v2($sheet_name, array $header_types, $col_options = null, $col_style1 = [], $style1 = null, $col_style2 = [], $style2 = null)`
