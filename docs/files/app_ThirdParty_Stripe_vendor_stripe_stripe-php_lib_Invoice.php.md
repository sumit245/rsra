...
- Path: `app\ThirdParty\Stripe\vendor\stripe\stripe-php\lib\Invoice.php`
- Type: PHP
- Size: 21976 bytes
...
**Classes**:
- `Stripe\Invoice extends ApiResource`

**Functions/Methods**:
- `finalizeInvoice($params = null, $opts = null)`
- `markUncollectible($params = null, $opts = null)`
- `pay($params = null, $opts = null)`
- `sendInvoice($params = null, $opts = null)`
- `upcoming($params = null, $opts = null)`
- `upcomingLines($params = null, $opts = null)`
- `voidInvoice($params = null, $opts = null)`
- `search($params = null, $opts = null)`
- `allLines($id, $params = null, $opts = null)`
