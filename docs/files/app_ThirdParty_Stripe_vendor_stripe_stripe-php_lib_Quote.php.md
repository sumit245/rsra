...
- Path: `app\ThirdParty\Stripe\vendor\stripe\stripe-php\lib\Quote.php`
- Type: PHP
- Size: 9013 bytes
...
**Classes**:
- `Stripe\Quote extends ApiResource`

**Functions/Methods**:
- `pdf($readBodyChunkCallable, $params = null, $opts = null)`
- `accept($params = null, $opts = null)`
- `cancel($params = null, $opts = null)`
- `finalizeQuote($params = null, $opts = null)`
