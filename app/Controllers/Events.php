...
class Events extends Security_Controller {
    ...
    function save_google_calendar_settings() {
        if (get_setting("enable_google_calendar_api")) {
            $settings = array("integrate_with_google_calendar", "google_client_id", "google_client_secret", "google_calendar_gmail");
            ...
            foreach ($settings as $setting) {
                ...
                if (get_setting('user_' . $this->login_user->id . '_google_calendar_authorized') && ($setting == "google_client_id" || $setting == "google_client_secret" || $setting == "google_calendar_gmail") && $integrate_with_google_calendar && get_setting('user_' . $this->login_user->id . '_' . $setting) != $value) {
