...
$lang["record_cannot_be_deleted"] = "Запись используется, невозможно удалить запись!";
...
$lang["out_date"] = "Дата окончания";
$lang["in_time"] = "Время начала";
$lang["out_time"] = "Время окончания";
...
$lang["members_clocked_out"] = "Закончили работу";
...
$lang["rejected_by"] = "Отклонено";
$lang["approved_by"] = "Одобрено";
...
/* учетная запись */
$lang["authentication_failed"] = "Проверка подлинности не пройдена!";
...
$lang["invite_an_user"] = "Пригласить пользователя для %s"; // Пригласить пользователя для {название компании}
...
$lang["customer_feedback"] = "Фидбек клиентов";
...
$lang["download_files"] = "Загрузить %s файла"; //Напр., загрузить 4 файла
...
$lang["client_replied"] = "Ответ отправлен клиенту";
...
$lang["can_manage_team_members_leave"] = "Получить право на управление отпусками участника команды?";
$lang["can_manage_team_members_timecards"] = "Получить право на управление карточками учета рабочего времени участника команды?";
$lang["can_access_invoices"] = "Получить доступ к счетам?";
$lang["can_access_expenses"] = "Получить доступ к расходам?";
$lang["can_access_clients_information"] = "Получить доступ к информации клиента?";
$lang["can_access_tickets"] = "Получить доступ к заявкам?";
$lang["can_manage_announcements"] = "Получить право на управление сообщениями?";
...
$lang["minimum_payment_validation_message"] = "Сумма оплаты не может быть меньше, чем: "; //Например. Сумма оплаты не может быть меньше, чем: 100 долларов
...
$lang["notification_project_task_assigned"] = "Задача поручена %s"; //Задача поручена господину Х
...
$lang["notification_project_member_added"] = "К проекту подключен %s."; //К проекту подключен господин Х.
$lang["notification_project_member_deleted"] = "%s удален из проекта."; //Господин Х удален из проекта.
...
$lang["notification_client_signup"] = "Зарегистрирован как новый клиент."; //Господин Х зарегистрирован как новый клиент.
...
$lang["notification_leave_approved"] = "Одобрено заявление на отпуск %s."; //Одобрено заявление на отпуск господина Х
$lang["notification_leave_assigned"] = "Утверждено заявление на отпуск %s."; //Утверждено заявление на отпуск господина Х
$lang["notification_leave_rejected"] = "Отклонено заявление на отпуск %s."; //Отклонено заявление на отпуск господина Х
...
$lang["mark_invoice_as_not_paid"] = "Выбрать Не оплачено"; //Изменить статус счета на Неоплаченный
...
$lang["estimate_request"] = "Заявка";
$lang["estimate_requests"] = "Заявки";
...
$lang["mark_as_processing"] = "Выбрать В работе";
$lang["mark_as_estimated"] = "Оценить";
$lang["mark_as_hold"] = "Выбрать В режиме ожидания";
$lang["mark_as_canceled"] = "Отменить";
...
$lang["can_access_proposals"] = "Есть ли доступ к предложениям?";
...
$lang["cant_see_the_timeline"] = "Не вижу шкалу времени";
...
$lang["prospects"] = "Перспективы";
$lang["estimate_forms"] = "Формы оценки";
...
$lang["has_open_tickets"] = "Есть открытые билеты";
$lang["clients_has_open_tickets"] = "У клиентов есть открытые тикеты";
...
$lang["hide_from_kanban_view"] = "Скрыть из представления канбана";

/* Version 2.9 */

$lang["contract"] = "Договор";
$lang["contracts"] = "Контракты";
$lang["can_access_contracts"] = "Можно получить доступ к контрактам?";
$lang["show_in_contract"] = "Показать в контракте";
$lang["contract_date"] = "Дата контракта";
$lang["edit_contract"] = "Редактировать контракт";
$lang["delete_contract"] = "Удалить контракт";
$lang["contract_sent_message"] = "Контракт отправлен!";
$lang["add_contract"] = "Добавить контракт";
$lang["contract_preview"] = "Предварительный просмотр контракта";
$lang["clone_contract"] = "Контракт клонирования";
$lang["contract_to"] = "Контракт с";
$lang["contract_settings"] = "Настройки контракта";
$lang["contract_color"] = "Цвет контракта";
$lang["send_contract_bcc_to"] = "При отправке контракта клиенту отправить BCC на";
$lang["initial_number_of_the_contract"] = "Начальный номер контракта";
$lang["the_contracts_id_must_be_larger_then_last_contract_id"] = "Идентификатор контракта должен быть больше, чем идентификатор последнего контракта.";
$lang["contract_sent"] = "Контракт отправлен";
$lang["notification_contract_sent"] = "Отправлен контракт";
$lang["contract_accepted"] = "Контракт принят";
$lang["notification_contract_accepted"] = "Принял контракт";
$lang["contract_rejected"] = "Контракт отклонен";
$lang["notification_contract_rejected"] = "Отклонил контракт";
$lang["create_estimate"] = "Создать оценку";
$lang["include_all_items_of_this_contract"] = "Включить все элементы этого контракта";
$lang["contract_view"] = "Просмотр контракта";
$lang["accept_contract"] = "Принять контракт";
$lang["reject_contract"] = "Отклонить контракт";
$lang["contract_accepted_message"] = "Вы успешно приняли этот контракт!";

$lang["contract_editor"] = "Редактор контрактов";
$lang["contract_templates"] = "Шаблоны контрактов";
$lang["add_contract_template"] = "Добавить шаблон контракта";
$lang["edit_contract_template"] = "Редактировать шаблон контракта";
$lang["delete_contract_template"] = "Удалить шаблон контракта";
$lang["use_template_from"] = "Использовать шаблон из";
$lang["print_contract"] = "Распечатать контракт";
$lang["contract_template_inserting_instruction"] = "Вы потеряете все несохраненные изменения, вставив шаблон.";

$lang["ticket_info"] = "Информация о билетах";
...
$lang["sales_and_prospects"] = "Продажи и перспективы";

$lang["contract_prefix"] = "Префикс контракта";
$lang["default_contract_template"] = "Шаблон контракта по умолчанию";

$lang["default_proposal_template"] = "Шаблон предложения по умолчанию";

$lang["signed_date"] = "Дата подписи";

$lang["add_signature_option_on_accepting_contract"] = "Добавить опцию подписи при принятии контракта";
$lang["accept"] = "Принимать";
...
$lang["sign_contract"] = "Подписать контракт";
...
$lang["edit_task_priority"] = "Изменить приоритет задачи";
$lang["delete_task_priority"] = "Удалить приоритет задачи";

$lang["import_items"] = "Импортировать элементы";
$lang["import_error_field_required"] = "Поле %s обязательно";

$lang["do_not_show_projects"] = "Не показывать проекты";

$lang["show_in_kanban"] = "Показать в канбане";
$lang["project_name"] = "Имя проекта";
$lang["client_name"] = "Имя клиента";

$lang["import_date_error_message"] = "Неверный формат даты.";

$lang["event_label"] = "Ярлык события";

$lang["undo"] = "Отменить";

$lang["clone_expense"] = "Клонирование расходов";
$lang["files_will_not_be_copied"] = "Файлы не будут скопированы.";

$lang["checklist_group"] = "Группа контрольных списков";
$lang["checklists"] = "Контрольные списки";
...
$lang["select_from_checklist_group"] = "Выбрать из группы контрольных списков";

$lang["import_leaves"] = "Импорт листьев";

$lang["import_tasks"] = "Импортировать задачи";

$lang["import_not_exists_error_message"] = "%s не найдено.";
$lang["import_task_points_error_message"] = "Поле баллов недействительно.";
$lang["user"] = "Пользователь";

$lang["checkout"] = "Оформить заказ";
$lang["all_plugins"] = "Все плагины";

$lang["payments_summary"] = "Сводка платежей";
$lang["yearly_summary"] = "Годовая сводка";
$lang["clients_summary"] = "Сводка клиентов";

$lang["import_leave_status_error_message"] = "Статус недействителен. Допустимые статусы: ";

$lang["import_expense"] = "Импортные расходы";

$lang["mark_as_default"] = "Пометить по умолчанию";
$lang["remove_as_default"] = "Удалить по умолчанию";
$lang["staff_default_dashboard_help_message"] = "Это заменит панель инструментов по умолчанию для всех членов команды. Обратите внимание, что виджеты будут распространяться в соответствии с разрешением пользователя.";
...
$lang["snooze_length"] = "Продолжительность повтора";
$lang["minutes"] = "Минуты";
$lang["reminder_sound_volume"] = "Громкость звука напоминания";
$lang["reminder_details"] = "Подробности напоминания";
$lang["mark_as_done"] = "Отметить как выполненное";
$lang["client_can_create_reminders"] = "Клиент может создавать напоминания?";

$lang["php_file_format_is_not_allowed"] = "Недопустимый формат файла PHP!";
...
$lang["estimate_sent_statistics"] = "Оценить отправленную статистику";

$lang["title_language_key"] = "Ключ языка заголовка";
$lang["placeholder_language_key"] = "Ключ языка-заполнителя";
$lang["keep_it_blank_if_you_do_not_use_translation"] = "Оставьте поле пустым, если не используете перевод";
$lang["language_key_recommendation_help_text"] = "Рекомендуется использовать любой префикс, например custom_field_";

$lang["other"] = "Другое";

$lang["print_estimate"] = "Распечатать смету";
...
$lang["no_announcement_yet"] = "Пока объявлений нет!";

$lang["team_members_overview"] = "Обзор участников команды";
$lang["on_leave_today"] = "Сегодня в отпуске";

$lang["enable_embedded_form_to_get_leads"] = "Включить встроенную форму для получения лидов";
$lang["please_submit_the_form"] = "Отправьте форму";
$lang["show_in_embedded_form"] = "Показать во встроенной форме";

$lang["after_submit"] = "После отправки";
$lang["return_json_response"] = "Вернуть ответ json";
$lang["show_text_result"] = "Показать текстовый результат";
$lang["redirect_to_this_url"] = "Перенаправить на этот URL:";

$lang["yes_only_own_timelogs"] = "Да, только собственные журналы времени";
$lang["yes_only_own_project_members"] = "Да, только собственные участники проекта";
$lang["excluding_his_her_timelogs"] = "Исключая его/ее собственные журналы времени";
$lang["can_add_own_timelogs_only"] = "Можно добавлять только собственные журналы времени";

$lang["all_tasks_overview"] = "Обзор всех задач";

$lang["invoice_overview"] = "Обзор счета";

$lang["next_reminder"] = "Следующее напоминание";

$lang["new_tickets_in_last_30_days"] = "Новые билеты за последние 30 дней";

$lang["individual"] = "Индивидуальный";

$lang["total_after_discount"] = "Всего после скидки";
