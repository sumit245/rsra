    ...
    <div class="card-body rounded-bottom" id="all-tasks-overview-widget">
        <div class="row">
            ...
            <div class="col-md-6 pl20 <?php echo count($task_statuses) > 8 ? "" : "pt-4"; ?>">
                ...
                foreach ($task_statuses as $task_status) {
                    ?>
                    <a href="<?php echo get_uri('projects/all_tasks/tasks_list/' . $task_status->status_id); ?>" class="text-default">
                        <div class="pb-2">
        ...
        <div class="position-absolute" style="bottom: 15px;">
            ...
            foreach ($task_priorities as $task_priority) {
                ?>
                <span class="me-5">
                    <a href="<?php echo get_uri('projects/all_tasks/tasks_list/0/' . $task_priority->priority_id); ?>" class="text-default">
