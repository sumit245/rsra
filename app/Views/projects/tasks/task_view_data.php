                    ...
                    <div class="col-md-12 mb15 b-t">
                        ...
                        <?php if ($can_edit_tasks) { ?>
                            ...
                            <div id="checklist-options-panel" class="mb15 p0 hide">
                                ...
                                <button id="checklist-template-toggle-button" type="button" class="btn btn-default ms-2 checklist-template-button"><span data-feather="hash" class="icon-16"></span> <?php echo app_lang('select_from_template'); ?></button>
