        ...
        $("#project-table").appTable({
            ...
            multiSelect: [{
                ...
                options: [{
                        ...
                        value: "open",
                        isChecked: selectOpenStatus
                    },
                    {
                        text: '<?php echo app_lang("completed") ?>',
                        value: "completed",
                        isChecked: selectCompletedStatus
                    },
                    {
                        text: '<?php echo app_lang("hold") ?>',
                        value: "hold",
                        isChecked: selectHoldStatus
                    },
                    {
                        text: '<?php echo app_lang("canceled") ?>',
                        value: "canceled"
                    }
                ]
            }],
            ...
            columns: [{
                ...
                {
                    title: '<?php echo app_lang("expense") ?>',
                    "class": "w10p"
                }, {
