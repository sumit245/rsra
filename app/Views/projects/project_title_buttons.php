...
if (can_access_reminders_module()) {
    echo modal_anchor(get_uri("events/reminders"), "<i data-feather='clock' class='icon-16'></i> " . app_lang('reminders'), array("class" => "btn btn-light", "id" => "reminder-icon", "data-post-project_id" => $project_info->id, "title" => app_lang('reminders') . " (" . app_lang('private') . ")"));
}
?>
