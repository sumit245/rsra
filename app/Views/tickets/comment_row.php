<div class="d-flex b-b p10 m0 text-break bg-white ticket-comment-container <?php echo $comment->is_note ? "note-background" : "" ?>">
    ...
    <div>
        ...
        <p><?php echo $comment->description ? nl2br(link_it($comment->description)) : ""; ?></p>
