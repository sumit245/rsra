        ...
        <div class="col-sm-9 col-lg-10">
            <div class="card">
                ...
                <div class="card-body"> 
                    ...
                    <div class="form-group">
                        <div class="row">
                            <label for="client_can_assign_tasks" class="col-md-2 col-xs-8 col-sm-4"><?php echo app_lang('client_can_assign_tasks'); ?></label>
                            <div class="col-md-10 col-xs-4 col-sm-8">
                                <?php
                                echo form_checkbox("client_can_assign_tasks", "1", get_setting("client_can_assign_tasks") ? true : false, "id='client_can_assign_tasks' class='form-check-input ml15'");
                                ?>                       
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        <div class="row">
                            <label for="client_can_create_reminders" class="col-md-2 col-xs-8 col-sm-4"><?php echo app_lang('client_can_create_reminders'); ?></label>
                            <div class="col-md-10 col-xs-4 col-sm-8">
                                <?php
                                echo form_checkbox("client_can_create_reminders", "1", get_setting("client_can_create_reminders") ? true : false, "id='client_can_create_reminders' class='form-check-input ml15'");
                                ?>
                            </div>
                        </div>
                    </div>
